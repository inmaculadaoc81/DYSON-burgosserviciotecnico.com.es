...
fallbackToggle.className = 'dysoncontrol-chat-fallback';
fallbackToggle.setAttribute('aria-label', 'Abrir chatbot DysonControl');
...
if (target && !target.dataset.dysoncontrolChatInitialized) {
  target.dataset.dysoncontrolChatInitialized = 'true';
